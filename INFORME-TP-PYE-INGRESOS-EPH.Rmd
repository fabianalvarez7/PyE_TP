...
Con un nivel de confianza del 95% se estima que la media real de los ingresos mensuales de los patrones se sitúa entre $1.685.000 y $2.025.000. Con el mismo criterio, el verdadero promedio de los ingresos del sector asalariado se encuentra entre $935.000 y $984.000, mientras que la media poblacional de los trabajadores por cuenta propia se ubica en el rango de los $715.000 a los $770.000. 

## 5. Conclusión

La falta de superposición visual y numérica entre los tres intervalos calculados ratifica una severa segmentación estructural en la distribución de la riqueza. Los empleadores consolidan una posición económica superior que duplica la remuneración de los asalariados y casi triplica la del autoempleo. Este comportamiento se comprende al relacionarlo con el análisis descriptivo del informe, donde se ve que la tasa de informalidad general alcanza el 44.9%, provocando que la mitad de la masa laboral precarizada perciba un ingreso medio de apenas $400.000 o menos. 

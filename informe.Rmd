---
title: "UNR - FCEIA - TUIA
        Probabilidad y Estadística
        Trabajo práctico"
subtitle: "Situación laboral de los ocupados en Argentina - EPH 4° Trimestre 2025"
...
## Fuente de los datos: https://www.indec.gob.ar/indec/web/Institucional-Indec-BasesDeDatos-1
...
**b)** Para cada grupo $i$ el parámetro de interés es la **media del ingreso mensual** ($\mu_i$): $\mu_1$ para patrones/empleadores, $\mu_2$ para cuentapropistas y $\mu_3$ para asalariados. El desvío estándar poblacional es desconocido, por lo que se aplica la distribución $t_{n_i-1}$. Los tamaños de grupo $\n_i$ superan los `r min(ic_ingreso$n)` casos, garantizando la validez del Teorema Central del Límite aun con la distribución asimétrica del ingreso.
...
knitr::include_graphics("graficos/g6_ic_ingreso.png")
```
